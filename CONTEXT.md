...
Public web-based game project for ClickG. Build an idle RPG-style game using Phaser. Initial scope: create the project structure first, then explore game ideas in the project channel.
